	...
	<body class="body">
		<div name="div1" id="div1" class="div1">
			<form name="frm1" id="frm1" class="frm1" action="c.php" method="post">
				...
				<table>
					<tr><td><input type="button" name="btnchpw" id="btnchpw" class="btnchpw" value="Change Password"></td></tr>
					<tr><td><a href="customerhome.php"><input type="button" name="btnhome" id="btnhome" class="btnhome" value="<< Back"></a></td></tr>
				</table>
